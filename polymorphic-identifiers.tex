...
We have generalized identifiers to \emph{Polymorphic Identifiers}, syntactically and
semantically integrating flexible resource access directly into a programming language,
and therefore avoiding the need to use string-based identifier lookup mechanisms.

Polymorphic Identifiers allow the substitution of alternate implementations,
as well as the introduction of custom, application-specific schemes.
