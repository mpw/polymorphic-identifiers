...
\mpw{OO polymorphism, verbs, very useful, but how to name/get the nouns}

\mpw{polymorphism in resource access: filesystems, web}
...
introduce {\em polymorphic identifiers} as a reification, abstraction and extension of existing 
identifier lookup mechanisms.  After that we look at components of the polymorphic identifier (PI)
system, {\em scheme resolvers} (section~\ref{schemes}), first class {\em references} (section~\ref{references}),
...
\mpw{KVC vs. PI performance, use MPWVarRef, caching works vs. caching doesn't work}
