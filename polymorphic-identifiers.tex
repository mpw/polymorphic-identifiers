...
section by:
\begin{enumerate}
\item reifying the identifier lookup process, 
\item making it user-extensible with open-implementation techniques and
...
Syntactically, \emph{polymorphic identifiers} are Universal Resouce Identifiers (URIs) 
